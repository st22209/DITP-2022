...
responses = ["get good", "skill issue", "bad", "dog water", "trash", "bad", "imagine not guessing right", "tbh sounds like a skill issue", "lmao bad get good"]
...
while guess_count > -1:
    ...
    print("You have {} guesses remaining! {}".format(guess_count, random.choice(responses)))
    guess_count -= 1
else:
    print("Imagine loosing, you dont have to cause you did.\n{}".format(random.choice(responses)))